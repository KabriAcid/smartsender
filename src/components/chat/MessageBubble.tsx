...
export function MessageBubble({ message, isCurrentUser }: MessageBubbleProps) {
    ...
    return (
        ...
        >
            <div
                className={`max-w-xs lg:max-w-md px-4 py-3 rounded-2xl ${isCurrentUser
            ...
            >
                ...
                <div className={`flex items-center gap-1 mt-1 text-xs ${isCurrentUser ? 'text-primary-foreground/70' : 'text-muted-foreground'
                    }`}>
...
function MediaItem({ media, isCurrentUser }: MediaItemProps) {
    ...
    return (
        <a
            href={media.url}
            download={media.name}
            className={`flex items-center gap-2 p-2 rounded-lg ${isCurrentUser
        ...
        >
            ...
            <div className="flex-1 min-w-0">
                ...
                <p className={`text-xs ${isCurrentUser ? 'text-primary-foreground/60' : 'text-muted-foreground'
                    }`}>
